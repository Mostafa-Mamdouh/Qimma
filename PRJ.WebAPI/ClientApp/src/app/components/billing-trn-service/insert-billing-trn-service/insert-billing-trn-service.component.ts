...
import { ItemsBilling, ItemsBillingHeader } from 'src/app/models/BillingService/ItemsBilling';
@Component({
...
Back(){
this.router.navigate(['/BillingTrnService'])
}
...
SubmitForm(){
  console.log(this.tableRows.controls);
