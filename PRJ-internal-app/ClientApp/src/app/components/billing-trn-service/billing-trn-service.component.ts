...
import { faListDots, faPen, faGlobe, faPlus, faXmark, faCircleUser, faHouse, faBrain, faUsersLine, faPersonBurst, faEnvelope, faArrowAltCircleLeft } from '@fortawesome/free-solid-svg-icons';
