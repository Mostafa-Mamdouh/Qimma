...
namespace PRJ_ID4Server.Controllers
{
	public class AccountController : Controller
	{
		...
		//public AccountController(SignInManager<ent.ExternalMaserUser> signInManager, UserManager<ent.ExternalMaserUser> userManager, IIdentityServerInteractionService interaction, IAuthenticationSchemeProvider schemeProvider, IClientStore clientStore, IEventService events)
		//{
		...
		//	var user = new ent.ExternalMaserUser { UserName = model.Email, Email = model.Email };
		...
		//	await _userManager.AddClaimAsync(user, new System.Security.Claims.Claim("name", user.UserName));
