...
namespace PRJ.DataAccess.Migrations
{
    ...
    [Migration("20230220125939_IntegrationServiceEntryFee")]
    partial class IntegrationServiceEntryFee
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.BillingServiceTrn.ServiceEntryFees", b =>
                {
                    ...
                    b.Property<int?>("ProcessIdLookupSetTermId")
                        .HasColumnType("int");

                    b.Property<int?>("StageIdLookupSetTermId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProcessIdLookupSetTermId");

                    b.HasIndex("StageIdLookupSetTermId");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.BillingServiceTrn.ServiceEntryFees", b =>
                {
                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "ProcessId")
                        .WithMany()
                        .HasForeignKey("ProcessIdLookupSetTermId");

                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "StageId")
                        .WithMany()
                        .HasForeignKey("StageIdLookupSetTermId");

                    b.Navigation("ProcessId");

                    b.Navigation("StageId");
                });
