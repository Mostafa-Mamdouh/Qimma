...
namespace PRJ.DataAccess.Migrations
{
    ...
    [Migration("20230117103958_Attachment Certificate")]
    partial class AttachmentCertificate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.ItemSourceFiles", b =>
                {
                    ...
                    b.Property<bool?>("FileAvailableFlag")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.ItemSourceProfile", b =>
                {
                    ...
                    b.Property<string>("EnrichmentOfUranium")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("NumberOfAcquiredSources")
                        .HasColumnType("int");

                    b.Property<int?>("NumberOfConsumedSources")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ShieldChemicalForm")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ShieldNuclearMaterialCode")
                        .HasColumnType("int");

                    b.Property<string>("ShieldPhysicalForm")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.LicenseInventoryLimits", b =>
                {
                    b.Property<int>("LicenseInventoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MaximumRadioactivity")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Radionuclide")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.LicenseProfile", b =>
                {
                    ...
                    b.Property<string>("PractiseSector")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.NuclearMaterial.NuclearMaterial", b =>
                {
                    ...
                    b.HasIndex("ItemSourceProfileId");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.PermitDetailsProfile", b =>
                {
                    ...
                    b.Property<string>("PermitDetailsDescAr")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");

                    b.Property<string>("PermitDetailsDescEn")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.PermitInventoryLimits", b =>
                {
                    b.Property<int>("PermitInventoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ModelMaximumRadioactivity")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.ItemSourceProfile", b =>
                {
                    ...
                    b.HasOne("PRJ.Domain.Entities.LicenseInventoryLimits", "LicenseInventoryLimits")
                        .WithMany()
                    ...
                    b.HasOne("PRJ.Domain.Entities.PermitInventoryLimits", "PermitInventoryLimits")
                        .WithMany()
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.NuclearMaterial.NuclearMaterial", b =>
                {
                    ...
                    b.HasOne("PRJ.Domain.Entities.ItemSourceProfile", "ItemSourceProfile")
                        .WithMany()
                        .HasForeignKey("ItemSourceProfileId");
