...
namespace PRJ.DataAccess.Migrations
{
    ...
    [Migration("20230301103737_addpracticesectoridtodetails")]
    partial class addpracticesectoridtodetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.AmanIntegrationEntities.LicenseInventoryEntities.LicenseGenerators", b =>
                {
                    ...
                    b.Property<string>("AmanId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("AmanInsertedOn")
                        .HasColumnType("datetime2");

                    b.Property<string>("AmanLicenseInventoryId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.AmanIntegrationEntities.LicenseInventoryLimits", b =>
                {
                    ...
                    b.Property<string>("AmanLicenseMasterId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.AmanIntegrationEntities.PermitInventoryEntities.PermitGenerators", b =>
                {
                    ...
                    b.Property<string>("AmanPermitInventoryId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.AmanIntegrationEntities.PermitInventoryLimits", b =>
                {
                    ...
                    b.Property<string>("AmanPermitMasterId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.BillingServiceTrn.BillingServiceTrnHeader", b =>
                {
                    ...
                    b.Property<int?>("BillingServiceTrnDetailsLineNum")
                        .HasColumnType("int");

                    b.Property<int?>("BillingServiceTrnDetailsTransactionID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BillingServiceTrnDetailsLineNum", "BillingServiceTrnDetailsTransactionID");

                    b.ToTable("BillingServiceTrnHeader");
                });

            modelBuilder.Entity("PRJ.Domain.Entities.BillingServiceTrn.ServiceEntryFees", b =>
                {
                    b.Property<int>("ServiceEntryFeesId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ServiceEntryFeesId"), 1L, 1);
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.FacilityProfile", b =>
                {
                    ...
                    b.Property<string>("AmanFacilityId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.LicenseProfile", b =>
                {
                    ...
                    b.Property<string>("AmanEntityId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.LicenseProfilePractice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("LicenseProfileId")
                        .HasColumnType("int");

                    b.Property<int>("PracticeLookup")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("LicenseProfileId");

                    b.HasIndex("PracticeLookup");

                    b.ToTable("LicenseProfilePractice");
                });
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.LookupSetTerm", b =>
                {
                    ...
                    b.HasIndex("LookupSetId", "AmanId")
                        .IsUnique()
                        .HasFilter("[AmanId] IS NOT NULL");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.PermitDetailsProfile", b =>
                {
                    ...
                    b.Property<string>("AmanLicenseId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.RelatedItem", b =>
                {
                    ...
                    b.Property<string>("HierarchyStructureCode")
                        .HasColumnType("nvarchar(256)");

                    b.Property<bool>("IsTechnologyAndSoftware")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("HierarchyStructureCode");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.RelatedItemFiles", b =>
                {
                    ...
                    b.HasIndex("RelatedItemCode");

                    b.ToTable("RelatedItemsFiles");
                });

            modelBuilder.Entity("PRJ.Domain.Entities.RelatedItemsHierarchyStructure", b =>
                {
                    b.Property<string>("ItemStructureCode")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.ToTable("RelatedItemsHierarchyStructure");
                });
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.AmanIntegrationEntities.LicenseInventoryEntities.LicenseSealedSources", b =>
                {
                    b.HasOne("PRJ.Domain.Entities.AmanIntegrationEntities.LicenseInventoryLimits", "LicenseInventory")
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.BillingServiceTrn.BillingServiceTrnHeader", b =>
                {
                    ...
                    b.HasOne("PRJ.Domain.Entities.BillingServiceTrn.BillingServiceTrnDetails", "BillingServiceTrnDetails")
                        .WithMany()
                        .HasForeignKey("BillingServiceTrnDetailsLineNum", "BillingServiceTrnDetailsTransactionID");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.BillingServiceTrn.ServiceEntryFees", b =>
                {
                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "PaymentTermsLookup")
                        .WithMany()
                        .HasForeignKey("PaymentTerms");

                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "ProcessIdLookup")
                        .WithMany()
                        .HasForeignKey("ProcessId");

                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "StageIdLookup")
                        .WithMany()
                        .HasForeignKey("StageId");

                    b.Navigation("PaymentTermsLookup");

                    b.Navigation("ProcessIdLookup");

                    b.Navigation("StageIdLookup");
                });
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.FacilityProfile", b =>
                {
                    ...
                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "ProvinceLookup")
                        .WithMany()
                        .HasForeignKey("Province");

                    b.Navigation("EntityProfile");

                    b.Navigation("ProvinceLookup");
                });
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.InternalFieldPermission", b =>
                {
                    ...
                    b.HasOne("PRJ.Domain.Entities.InternalRole", "InternalRole")
                        .WithMany("InternalFieldPermissions")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.LegalRepresentativesProfile", b =>
                {
                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "UserTypeLookup")
                        .WithMany()
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.LicenseProfilePractice", b =>
                {
                    b.HasOne("PRJ.Domain.Entities.LicenseProfile", "LicenseProfile")
                        .WithMany("LicensePractices")
                        .HasForeignKey("LicenseProfileId");

                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "Practice")
                        .WithMany()
                        .HasForeignKey("PracticeLookup")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.NuclearMaterial.NuclearMaterial", b =>
                {
                    ...
                    b.HasOne("PRJ.Domain.Entities.LookupSetTerm", "QuantityUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.RelatedItem", b =>
                {
                    ...
                    b.HasOne("PRJ.Domain.Entities.RelatedItemsHierarchyStructure", "HierarchyStructure")
                        .WithMany("RelatedItems")
                        .HasForeignKey("HierarchyStructureCode")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("HierarchyStructure");
            ...
            modelBuilder.Entity("PRJ.Domain.Entities.RelatedItemFiles", b =>
                {
                    b.HasOne("PRJ.Domain.Entities.RelatedItem", "RelatedItem")
                        .WithMany("RelatedItemFiles")
                        .HasForeignKey("RelatedItemCode")
                        .OnDelete(DeleteBehavior.Cascade);
